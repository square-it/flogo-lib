...
func GenerateGoMetadata(dir string) ( []*Dependency, error) {

	fmt.Println("Generating flogo metadata in ", dir)
...
func ParseTriggerMetadata(metadataJson []byte) (*TriggerMetadata, error) {
